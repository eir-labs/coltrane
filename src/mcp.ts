...
export const MCP_TOOLS: readonly MCPToolDef[] = [
  ...
  { slug: "gig_dispatch",                  category: "run", input_schema: obj({ standard_slug: "string", chart_slug: "string", venue: "string", repo_url: "string", acting_for: "string", input: "object", gig_input_omitted: "boolean", depth: "string", effort: "string", wait: "boolean", budget: { type: "object", description: "per-gig cost ceiling in US dollars", properties: { max_usd: { type: "number", description: "the per-gig ceiling, in USD (US dollars)" } } }, resume_gig_id: "string", reuse: "boolean", approvals: "object", approved_by: "string" }), output_schema: obj({ gig_id: "string", status: "string", awaiting: "object", depth: "string", manifest: "object", resumed_from: "string", reuse: "boolean", resume_refused: "boolean", drift: "array" }) },
